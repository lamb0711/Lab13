...
public class Prob1 {//main class Prob1
	...
	public static void main(String[] args) {//main method
		...
		InstanceOf.whatFriend(friend1);//call class method whatFrend in InstanceOf class
		InstanceOf.whatFriend(friend2);//call class method whatFrend in InstanceOf class
		InstanceOf.whatFriend(friend3);//call class method whatFrend in InstanceOf class
